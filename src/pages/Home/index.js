    ...
    return (
        <div className="bg-home w-screen">
            ...
            <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 py-8 lg:py-12">
                <div className="md:min-h-screen xl:min-h-full">
                    <HeroSection />
                </div>
            </div>
            <div className="relative">
                <img
                    src="./assets/imgs/video_back_effect.png"
                    className="w-full h-[952px] absolute -top-72"
                />
            </div>
            <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 py-8 lg:py-12">
            ...
            <div className="rounded-[48px] bg-gradient-radial -mt-24 md:-mt-28 lg:-mt-32 pt-28 md:pt-32 lg:pt-44">
                <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 pt-8 lg:pt-12">
                ...
                <div className="relative">
                    <img
                        src="./assets/imgs/horizontal_back_effect.png"
                        className="w-full h-[1800px] absolute z-0"
                    />
                </div>

                <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 pb-8 lg:pb-12 relative z-10">
                    ...
                    {HorizontalIntroList.map((item, index) => {
                        return (
                            <div key={index} className="mb-24 lg:mb-28">
                                <HorizontalIntroCard
                                    title={item?.title}
                                    des={item?.des}
                                    icon={item?.icon}
